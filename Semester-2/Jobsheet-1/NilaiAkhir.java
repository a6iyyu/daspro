...
public class NilaiAkhir {
    public static String kelulusan;
    ...
    public static String kelulusan(double rata_rata) {
        if (rata_rata > 50 || rata_rata <= 100) {
            return kelulusan = "SELAMAT ANDA LULUS";
        } else {
            return null;
        }
    }
    ...
    public static void main(String[] args) {
        try (Scanner sc = new Scanner(System.in)) {
            ...
            if (tugas < 0 || tugas > 100 || kuis < 0 || kuis > 100 || uts < 0 || uts > 100 || uas < 0 || uas > 100) {
                ...
                rata_rata = 0.2 * tugas + 0.2 * kuis + 0.3 * uts + 0.3 * uas;
            ...
            System.out.println("=========================");
            System.out.println("=========================");
            System.out.print(kelulusan(rata_rata) + "\n");
        }
    }
}